...
CREATE TABLE IF NOT EXISTS vod_streams (
    ...
    allow_deny ENUM('allow', 'deny') COMMENT 'Explicit allow/deny override for this stream',
    ...
    INDEX idx_vod_streams_allow_deny (source_id, allow_deny),
    INDEX idx_vod_streams_added_date (source_id, added_date),
    INDEX idx_vod_streams_release_date (source_id, release_date)
