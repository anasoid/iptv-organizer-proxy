...
public class StreamingJsonParser {
    ...
    /**
     * Parse JSON array from input stream and emit items as Multi<T>
     * Processes in 128KB chunks with explicit GC every 1000 items
     */
                ...
                try {
                    ...
                    while (parser.nextToken() != JsonToken.END_ARRAY) {
                        try {
                            ...
                            emitter.fail(new StreamingException("Failed to parse array element at index: " + itemCounter.get(), e));
                            return;
                        }
                    }
    ...
    /**
     * Parse JSON stream (array or single object) and emit as JsonNode
     * More flexible than parseJsonArray - handles various JSON structures
     */
            ...
            .emitter(emitter -> {
                try {
                    ...
                    // Handle other cases (null, primitives, etc.)
                        ...
                        emitter.fail(new StreamingException("Unexpected JSON token: " + token + ". Expected array or object"));
                    }
