...
/**
 * Extracts labels from names using delimiter-based parsing
 * Matches PHP implementation: brackets [], pipes |, and dashes -
 */
@ApplicationScoped
public class LabelExtractor {
    ...
    /**
     * Extract labels from text (category name or stream name)
     * Uses delimiter-based parsing: brackets [], pipes |, and dashes -
     *
