...
public class SyncLogRepository extends BaseRepository<SyncLog> {
  ...
  public Uni<Long> insert(SyncLog syncLog) {
    ...
    io.vertx.mutiny.sqlclient.Tuple tuple =
        io.vertx.mutiny.sqlclient.Tuple.tuple()
            ...
            .addLocalDateTime(
                syncLog.getCreatedAt() != null
                    ? syncLog.getCreatedAt()
                    : java.time.LocalDateTime.now())
            .addLocalDateTime(
                syncLog.getUpdatedAt() != null
  ...
  public Multi<SyncLog> findBySourceIdFiltered(
  ...
  public Multi<SyncLog> findBySourceId(Long sourceId) {
    return pool.preparedQuery(
            "SELECT * FROM sync_logs WHERE source_id = ? ORDER BY started_at DESC")
