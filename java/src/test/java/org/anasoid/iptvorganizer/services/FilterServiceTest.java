...
public class FilterServiceTest {
  ...
  void testMatchesWithIncludePattern() {
    ...
    FilterConfig config = FilterConfig.builder().rules(List.of(rule)).build();
  ...
  void testMatchesMultipleRulesAllMustPass() {
    ...
    FilterConfig config = FilterConfig.builder().rules(List.of(rule1, rule2)).build();
  ...
  void testMatchesEmptyConfig() {
    FilterConfig config = FilterConfig.builder().rules(List.of()).build();
